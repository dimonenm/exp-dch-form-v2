  ...
  return (
    <>
      <Card radius="lg" shadow="sm" className="p-4 bg-white">
        <CardBody>
          <div className="grid grid-cols-3 gap-3 text-sm font-normal">
            <div className='grid grid-cols-4 text-center'>
              ...
              <div>
                ...
                <div className="p-1 font-normal text-xs">1234<br />от 11.09.2025</div>
              </div>

              <div>
                <div className="bg-default-100 p-1 rounded">ОВД</div>
                <div className="h-10 p-1 font-normal">Евпатория</div>
              </div>
              <div className="col-span-2">
            ...
            <div className='grid grid-cols-4  text-center'>
              ...
              <div className="col-span-1">
                ...
                <div className="p-1 font-normal h-10">Иванов</div>
              </div>
              <div className="col-span-2">
